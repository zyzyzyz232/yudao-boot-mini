...
@Schema(description = "管理后台 - 人脸照片及特征数据 Response VO")
@Data
...
public class PhotosRespVO {
    ...
    @ExcelProperty("人脸特征向量数据(通常是一组浮点数数组)，PostgreSQL推荐用 vector 类型")
    ...
    @ExcelProperty("是否为该人员的主参考底库照片：1-是，0-否")
    private Boolean isPrimary;

    @Schema(description = "照片来源：manual_upload, camera_device, api_sync等")
    @ExcelProperty("照片来源：manual_upload, camera_device, api_sync等")
